...
/// at 1.1.33, then `Zn`/`MYA`/`FYA`/`UYA` at 1.1.40), so a grep written against
...
/// qodercli carries its ancestry.
/// Re-checked against the pinned 1.1.40 bundle: same precedence, same keys,
